...
public class Main {
    ...
    private static void registrarCelular() throws Exception {
        ...
        System.out.println("Sistema Operativo (ANDROID/IOS/HARMONYOS): ");
        SistemaOperativo so = SistemaOperativo.valueOf(scanner.nextLine().trim().toUpperCase());
        System.out.println("Gama (ALTA/MEDIA/BAJA): ");
        CategoriaGama gama = CategoriaGama.valueOf(scanner.nextLine().trim().toUpperCase());

        Celular celular = FactoryCelular.crear(marca, modelo, precio, stock, so, gama);
    ...
    private static void listarClientes() throws SQLException {
        ...
        for (Cliente c : lista) {
            System.out.println("ID: " + c.getId() + " | " + c.getNombre()
                    + " | " + c.getIdentificacion() + " | " + c.getCorreo());
        }
    }
    ...
    private static void registrarVenta() throws Exception {
        ...
        while (agregarMas) {
            ...
            System.out.println("💰 Precio con descuento (" + strategy.getDescripcion()
                    + "): $" + precioFinal);
        ...
        switch (op) {
            case 1:
                ...
                if (stockBajo.isEmpty()) {
                    ...
                    stockBajo.forEach(c -> System.out.println(
                            c.getMarca() + " " + c.getModelo() + " — Stock: " + c.getStock()));
                }
                break;
            case 2:
                ...
                if (top3.isEmpty()) {
                    ...
                    top3.forEach(c -> System.out.println(c.getMarca() + " " + c.getModelo()));
                }
                break;
            case 3:
